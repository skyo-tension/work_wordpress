<?php get_header(); ?>
	...
	<main>
		...
		<div class="smartphone_list">
			<div class="contents2 fadein">
				<h2 class="ttl_h2">端末一覧</h2>
				<div class="searchandfilter">
					<ul class="cate">
						<li><a href="<?php echo home_url(); ?>/smartphone/" class="on">すべて</a></li>
						<?php
				...
				<ul class="cf">
					...
					<li class="matchHeight">
						<a href="<?php the_permalink() ?>">
							<p class="label"></p>
							<?php if (has_post_thumbnail()) : ?><?php the_post_thumbnail('full', ['class' => 'object-fit-img hover_img']); ?><?php else : ?><img src="<?php bloginfo('template_url'); ?>/images/index/news00.jpg" alt="デフォルト画像" class="object-fit-img hover_img"><?php endif ; ?>
							<h3><?php the_title(); ?></h3>
							<p class="price"><?php the_field('price'); ?><span>円～</span></p>
						</a>
					</li>
